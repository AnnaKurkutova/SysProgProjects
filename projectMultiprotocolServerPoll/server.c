...
*  select(). Когда один из клиентов TCP/UDP подключается к серверу,        *
*  происходит снятие блокировки и выполняются приём сообщения от клиента   *
*  и отправка сообщения с текущим временем клиенту.                        *
***************************************************************************/
